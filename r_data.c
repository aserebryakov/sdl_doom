...
void R_InitTextures (void)
{
    ...
    texturecolumnlump = static_cast<short int**>(Z_Malloc (numtextures*4, PU_STATIC, 0));
    texturecolumnofs = static_cast<short unsigned int**>(Z_Malloc (numtextures*4, PU_STATIC, 0));
	...
	texturecolumnlump[i] = static_cast<short int*>(Z_Malloc (texture->width*2, PU_STATIC,0));
	texturecolumnofs[i] = static_cast<short unsigned int*>(Z_Malloc (texture->width*2, PU_STATIC,0));
...
void R_InitColormaps (void)
{
    ...
    // TODO: Again some hack
    colormaps = (byte *)( (reinterpret_cast<size_t>(colormaps) + 255)&~0xff); 
